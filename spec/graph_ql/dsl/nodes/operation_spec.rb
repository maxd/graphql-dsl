  ...
  context '#initialize' do
    context 'with all arguments' do
      ...
      it('expected variable definitions') do
        expect(operation.__variable_definitions).to all be_a(GraphQL::DSL::Nodes::Containers::VariableDefinition)
      end
      it('expected directives') do
        expect(operation.__directives).to all be_a(GraphQL::DSL::Nodes::Containers::Directive)
      end
