      ...
      module Containers
        ...
        class VariableDefinition
          ...
          def initialize(name, type, default = UNDEFINED, directives = [])
            ...
            raise GraphQL::DSL::Error, 'Variable type must be specified' if type.nil? || type.empty?
          ...
          class << self
            ...
            #
            # @param value [Hash, Array, VariableDefinition] Hash, Array or VariableDefinition
            #
            ...
            def from(name, value)
              ...
              when Array then from_array(name, value)
                ...
                raise GraphQL::DSL::Error.new('Unsupported format of variable definition', class: value.class.name)
              end
            end
